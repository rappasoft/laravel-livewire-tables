            ...
            <div>
                <span class="rounded-md shadow-sm">
                    <button
                        ...
                        type="button"
                        class="inline-flex justify-center w-full rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 {{ $this->customThemeColor ? "focus:border-{$this->customThemeColor}-300 focus:ring focus:ring-{$this->customThemeColor}-200" : 'focus:border-indigo-300 focus:ring focus:ring-indigo-200' }}  focus:ring-opacity-50 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:hover:bg-gray-600"
                        id="options-menu"
                        aria-haspopup="true"
