                ...
                <div class="p-2"
                    ...
                    <div wire:key="columnSelect-{{ $loop->index }}">
                        <label wire:loading.attr="disabled"
                            ...
                            <input class="{{ $this->customThemeColor ? "text-{$this->customThemeColor}-600 focus:border-{$this->customThemeColor}-300 focus:ring-{$this->customThemeColor}-200" : 'text-indigo-600 focus:border-indigo-300 focus:ring-indigo-200 ' }} rounded border-gray-300 shadow-sm transition duration-150 ease-in-out focus:ring focus:ring-opacity-50 dark:bg-gray-900 dark:text-white dark:border-gray-600 dark:hover:bg-gray-600 dark:focus:bg-gray-600 disabled:opacity-50 disabled:cursor-wait"
