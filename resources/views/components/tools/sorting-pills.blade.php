    ...
    <div>
        @if ($this->sortingPillsAreEnabled() && $this->hasSorts())
            <div class="mb-4 px-4 md:p-0" x-cloak x-show="!currentlyReorderingStatus">
                <small class="text-gray-700 dark:text-white">{{ __('livewire-tables::core.Applied Sorting') }}:</small>
                ...
                @foreach($this->getSorts() as $columnSelectName => $direction)
                    ...
                    >
                        ...
                        >
                            <span class="sr-only">{{ __('livewire-tables::core.Remove sort option') }}</span>
    ...
    <div>
        @if ($this->sortingPillsAreEnabled() && $this->hasSorts())
            <div class="mb-3" x-cloak x-show="!currentlyReorderingStatus">
                <small>{{ __('livewire-tables::core.Applied Sorting') }}:</small>
            ...
            <div class="mb-3" x-cloak x-show="!currentlyReorderingStatus">
                ...
                @foreach($this->getSorts() as $columnSelectName => $direction)
                    ...
                    >
                        ...
                        >
                            <span class="visually-hidden">{{ __('livewire-tables::core.Remove sort option') }}</span>
                            <x-heroicon-m-x-mark class="laravel-livewire-tables-btn-smaller" />
                        </a>
                    </span>
                @endforeach
