                ...
                @if ($selectAll)
                    <div wire:key="all-selected-{{ $table }}">
                        ...
                        <button
                            ...
                            type="button"
                            class="ltr:ml-1 rtl:mr-1 text-blue-600 underline text-gray-700 text-sm leading-5 font-medium focus:outline-none focus:text-gray-800 focus:underline transition duration-150 ease-in-out dark:text-white dark:hover:text-gray-400"
                        >
                            @lang('Deselect All')
                        </button>
                    </div>
