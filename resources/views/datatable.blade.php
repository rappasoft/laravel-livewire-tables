        ...
        <x-livewire-tables::table>
            ...
            @empty
                @if($this->hasCustomEmptyView())
                    <x-livewire-tables::table.tr.plain class="{{ $this->getCustomEmptyClasses()['row'] }}">
                        <x-livewire-tables::table.td.plain colspan="100%" class="{{ $this->getCustomEmptyClasses()['col'] }}">
