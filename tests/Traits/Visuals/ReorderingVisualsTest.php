...
class ReorderingVisualsTest extends TestCase
{
    ...
    public function sorting_is_disabled_on_reorder(): void
    {
        Livewire::test(PetsTable::class)
            ...
            ->call('sortBy', 'id')
            ->assertSet('table', ['sorts' => ['id' => 'asc'], 'filters' => ['breed' => [], 'species' => [], 'breed_id_filter' => null, 'pet_name_filter' => null], 'columns' => []])
...
//            ->assertSet('page', 3);
    ...
    public function filters_are_disabled_on_reorder(): void
    {
        Livewire::test(PetsTable::class)
            ...
            ->assertSet('table', ['filters' => ['breed' => [1], 'species' => [], 'breed_id_filter' => null, 'pet_name_filter' => null], 'sorts' => [], 'columns' => []])
            ->assertSee('Filters')
            ->call('enableReordering')
