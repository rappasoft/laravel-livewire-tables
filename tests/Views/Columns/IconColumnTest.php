...
final class IconColumnTest extends TestCase
{
    ...
    public function test_icons_correctly_via_value(): void
    {
        ...
        $column = IconColumn::make('Old Age', 'age')
            ->setIcon(function (Pet $row, int $value) { if($value >= 5) { return "heroicon-o-check-circle"; } else { return "heroicon-o-x-circle"; } });
    ...
    public function test_icons_correctly_via_row(): void
    {
        $rows = $this->basicTable->getRows();
        $column = IconColumn::make('Old Age', 'age')
            ->setIcon(function (Pet $row) { if($row->age >= 7) { return "old-icon"; } else { return "young-icon"; } });
